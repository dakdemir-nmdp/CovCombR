...
We can directly compare the estimated covariance matrix with the full-data covariance matrix by inspecting the printed outputs above. The `CovCombR` estimate closely matches the full-data covariance, even for the off-diagonal elements that were not observed in some studies.
